<html>
<head>
  <title>Toko Online Sepatu</title>
     ...
     <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" >Toko Sepatu</a>
          </div>
     ...
     <div class="row">
       <?php foreach($product as $p){ ?>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="kotak">
            <a href="#"></a>  
            <center><a href="#"><img class width="150px" height="150x ="img-thumbnail" src="<?php echo base_url() . 'assets/images/'.$p->gambar  ?>"/></a>
              <div class="card-body">
                <h1 class="card-title">
